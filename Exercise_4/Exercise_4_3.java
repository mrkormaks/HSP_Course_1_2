...
class Player {
  ...
  public void interact(String gameObjectName) {
    System.out.println("Player interacts with the: " + gameObjectName);
  }

  public void interact(int itemId) {
    System.out.println("Player collects item with ID: " + itemId);
  }
}
...
public class Exercise_4_3 {
  public static void main(String[] args) {
    ...
    Weapon crossbow = new Crossbow("Hunter's Crossbow", 20, 7, 5, 150, 25);
    Weapon bow = new Bow("Elven Bow", 15, 3, 10, 3);
    crossbow.attack();
    bow.attack();

    // Пример ad hoc полиморфизма
    Player player = new Player("Hero", 100, 100.0f, 50, 1, null, null);
    player.interact("Treasure chest");
    player.interact(587248);
  }
}
