# Отчёт по системам управления проектами #
## YandexTracker ##
### Создание проекта разработки мобильного приложения для назначения и отслеживания статуса текущих задач ###
![image](https://github.com/user-attachments/assets/4dd363f8-459f-45fd-bc83-e7fbb05baf6f)
### Создание задач по проекту, смена статуса задачи ###
